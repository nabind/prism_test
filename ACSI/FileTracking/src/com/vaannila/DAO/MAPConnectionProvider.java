...
public class MAPConnectionProvider {
	private static JDCConnectionDriver driver = null;
	private static String DATA_SOURCE = "jdbc:jdc:usmo";
	
	private MAPConnectionProvider() {}
	...
	public static JDCConnectionDriver getDriver() throws Exception {
		if(driver == null) {
			Properties prop = PropertyFile.loadProperties("map.properties");
			loadDriver(prop);
		}
		return driver;
	}
