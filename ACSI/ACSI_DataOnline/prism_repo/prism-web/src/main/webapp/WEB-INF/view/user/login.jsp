	...
	<div class="columns">
		...
		<div class="four-columns" style="min-width:317px">
			<p class="big-message white-gradient" style="height:50px">
				...
				<strong>ACSI Data Online</strong><br>
				Administrators/Teachers click here
			</p>
			<a href="userlogin.do?theme=acsi" class="button blue-gradient full-width">Login</a>
		</div>
		...
		<div class="four-columns" style="min-width:317px">
			...
			<a href="userlogin.do?theme=parent" class="button blue-gradient full-width">Login</a>
		</div>
		<div class="two-columns"></div>
	</div>
