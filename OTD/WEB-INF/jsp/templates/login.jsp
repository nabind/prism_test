...
<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
    ...
    <t:putAttribute name="footerContent">
		...
		<h2 style="display:none"><a id="needHelp"><spring:message code='LOGIN_NEED_HELP_LINK'/></a></h2>
		<!--
...
<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
    <t:putAttribute name="containerClass">panel dialog inlay login ${containerClass}</t:putAttribute>
    <t:putAttribute name="containerID" value="login"/>
    <t:putAttribute name="containerTitle">Message</t:putAttribute>
    <t:putAttribute name="bodyContent">
		<fieldset>
			<legend class="offLeft"><span>sd sds dsds ds dsdsds</span></legend>
		</fieldset>
	</t:putAttribute>
</t:insertTemplate>