...
<script id="exportOptionsTemplates" type="template/mustache">
        <fieldset id="exportOptions" class="group">
            ...
            <ul class="list inputSet">
                ...
                <li class="leaf">
                    <div class="control checkBox">
                        <label class="wrap" title="" for=""><spring:message code="export.role.users"/></label>
                        <input id="roleUsers" class="" type="checkbox" value="" name="" {{#userForRoles}}checked="checked"{{/userForRoles}}>
                    </div>
                </li>
                <li class="leaf">
                    <ul class="list inputSet">
                ...
                <%--TODO: unctomment me or remove--%>
                <%--<li class="leaf">--%>
                    <%--<div class="control checkBox">--%>
                        <%--<label class="wrap" title="" for=""><spring:message code="export.include.system.properties"/></label>--%>
                        <%--<input id="includeSystemProperties" class="" type="checkbox" value="" name="" {{#includeSystemProperties}}checked="checked"{{/includeSystemProperties}}>--%>
                    <%--</div>--%>
                <%--</li>--%>
            </ul>
        </fieldset>
