        ...
        <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
            ...
            <t:putAttribute name="headerContent">
                ...
                <script type="text/javascript"
                        src="${pageContext.request.contextPath}/scripts/resource.analysisConnection.dataSource.locate.js"></script>
            </t:putAttribute>
                                        ...
                                        <li id="create" class="leaf">
											<div class="control radio">
												<label class="wrap" for="LOCAL" title="<spring:message code='addResources.analysisClient.defineDataSource'/>">
														<spring:message code='addResources.analysisClient.defineDataSource' javaScriptEscape='true'/>
												</label>
                                        ...
                                        <li id="fromRepo" class="leaf">
                                            ...
                                            <spring:bind path="dataResource.selectedUri">
                                                <label class="control browser<c:if test="${status.error}"> error</c:if>" for="resourceUri"  title="<spring:message code='resource.report.repository'/>">
                                                    <input id="resourceUri" type="text" name="${status.expression}" value="${status.value}" <c:if test="${empty status.value}">disabled="disabled"</c:if>/>
                                                    <button id="browser_button" class="button action" <c:if test="${empty status.value}">disabled="disabled"</c:if>><span class="wrap"><spring:message code="button.browse"/><span class="icon"></span></span></button>
