...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/jpivot.jaPro.js"></script>
...
<form id="olapViewForm" action="<c:url value='viewOlap.html'/>" method="post">
    <wcf:scroller/>
