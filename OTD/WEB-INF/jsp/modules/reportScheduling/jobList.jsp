			    ...
			    <t:putAttribute name="headerContent">	
					...
					<div class="toolbar">
						<ul class="list buttonSet">
							<li class="node open">
								<ul class="list buttonSet">
									<li class="leaf"><button id="back" class="button capsule text up"><span class="wrap"><spring:message code="button.back"/></span><span class="icon"></span></button></li>
								</ul>
							</li>
							<li class="node open">
								<ul class="list buttonSet">
									<li class="leaf"><button id="scheduleJob" class="button capsule text first up"><span class="wrap"><spring:message code="report.scheduling.list.button.new"/></span><span class="icon"></span></button></li>
									<li class="leaf"><button id="runNow" class="button capsule text last up"><span class="wrap"><spring:message code="report.scheduling.list.button.now"/></span><span class="icon"></span></button></li>
								</ul>
							</li>
							<li class="node open">
								<ul class="list buttonSet">
									<li class="leaf"><button id="refresh" class="button capsule text up"><span class="wrap"><spring:message code="report.scheduling.list.button.refresh"/></span><span class="icon"></span></button></li>
								</ul>
							</li>
						</ul>
					</div>
