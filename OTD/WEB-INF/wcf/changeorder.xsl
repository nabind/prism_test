...
<xsl:template match="move-button[@style='fwd']">
  <input border="0" type="image" name="{@id}" src="{$context}/wcf/changeorder/move-down.png" title="{@title}" width="9" height="9"/>
</xsl:template>

<xsl:template match="move-button[@style='bwd']">
  <input border="0" type="image" name="{@id}" src="{$context}/wcf/changeorder/move-up.png" title="{@title}" width="9" height="9"/>
</xsl:template>
...
<xsl:template match="move-button">
  <img src="{$context}/wcf/changeorder/move-empty.png" onclick="pageAlert=false" width="9" height="9"/>
</xsl:template>
