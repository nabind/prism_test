...
<html>
    <head>
        <title>OTD : <decorator:title /></title>
...
<c:choose>
    ...
    <div id="banner" class="banner">
        ...
        <ul id="metaLinks" class="sectionRight">
            <li id="userID">
                Welcome: <authz:authorize ifNotGranted="ROLE_ANONYMOUS">
			            <span id="casted">
                    ...
                    <span class="userName"><authz:authentication property="principal.fullName"/></span>
                </authz:authorize>
            </li>
            ...
            <br/><li id="main_logOut" class="last"><a id="main_logOut_link"><spring:message code="menu.logout"/></a></li>
        </ul>
    </div>
    ...
    <div id="frameFooter">
        ...
        <p id="copyright">Copyright &copy; by CTB/McGraw-Hill LLC. All rights reserved.</p>
    </div>
