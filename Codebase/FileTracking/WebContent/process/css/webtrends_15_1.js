...
// Created: 10/21/2009
// customized 07/2010 wt/egerhardt to trim overly long wt_linkid values (line 665)
...
WebTrends.prototype.dcsTag=function(){
	...
	// if wt_linkid is present and pushing P.length over 2048, trim wt_linkid as cleanly as possible to bring P.length under 2048
	// added 070110 wt/egerhardt
	if (P.length>2048&&navigator.userAgent.indexOf('MSIE')>=0&&P.indexOf('wt_linkid')!=-1){
		var lidTrim=P.substring(P.indexOf('wt_linkid'),P.indexOf('&',P.indexOf('wt_linkid')));
		lidTrim=lidTrim.substring(0,lidTrim.length-(P.length-2048));
		lidTrim=lidTrim.substring(0,lidTrim.lastIndexOf('%3B'));
		P=P.substring(0,P.indexOf('wt_linkid'))+lidTrim+P.substring(P.indexOf('&',P.indexOf('wt_linkid')));
	}
	// end addition 070110 wt/egerhardt
