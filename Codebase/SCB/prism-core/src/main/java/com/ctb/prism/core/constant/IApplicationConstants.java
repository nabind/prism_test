...
public interface IApplicationConstants {
	...
	public static final String ROLE_GROWTH_ID = "8";
	public static final long ROLE_EDU_ADMIN_ID = 9;
	public static final String ROLE_RESCORE_ID = "12";
