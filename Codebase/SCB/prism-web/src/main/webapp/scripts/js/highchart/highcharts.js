...
///////////////////////////////////////////////////////////////////////
// #1 4/9/14, 4/10/14 amd-fication - Header; added dependency to jQuery.
//
// #2 4/9/14 amd-fication - Highcharts removed from
// global namespace
//
// #3 4/9/14 amd-fication - Footer
//
// #4 4/10/2014 global variable HighchartsAdapter was put
// into Highcharts.__HighchartsAdapter__ property
//
// #5 4/10/2014 former global variable HighchartsAdapter is now read
// from Highcharts.__HighchartsAdapter__ property
//
// #6 4/25/2014 replaced "doc" variable by document related to container element
// It fixes zoom if chart rendered in iframe
//
// #7 4/25/2014 use local jQuery variable, not from win.jQuery
//
// #8 7/21/2014 revert Highcharts bug 2466
//
// #9 7/29/2014 extend reset zoom button options for html rendering
//
// #10 8/13/2014 fix legend item baseline calculating when it set in em
//  this problem may be fixed in 4.0.3 highcharts
//
// #11 8/14/2014 patch zoom for heatmap when it rendering by canvas, hour labels
//
// #12 9/30/2014 fix JRS-2512, Y-axis labels step.
//
...
(function (factory, globalScope) {
    ...
    if (typeof define === "function" && define.amd) {
        ...
        // Browser globals.
        globalScope.Highcharts = factory(globalScope.jQuery);
    }
}(function (jQuery) {
    //END JASPERSOFT #1
    ...
    (function ($) {
         ...
         */
            //JASPERSOFT #4
        Highcharts.__HighchartsAdapter__ = win.HighchartsAdapter || ($ && {
            //END JASPERSOFT #4
    ...
    //JASPERSOFT #5
    var globalAdapter = Highcharts.__HighchartsAdapter__,
    ...
    Tick.prototype = {
        ...
        getLabelPosition: function (x, y, label, horiz, labelOptions, tickmarkOffset, index, step) {
            ...
            //JASPERSOFT #15
            y = y + (axis.coll === "xAxis" && !horiz ? 0 : this.yOffset) - (tickmarkOffset && !horiz ?
                tickmarkOffset * transA * (reversed ? 1 : -1) : 0);
            //END JASPERSOFT #15
        ...
        render: function (index, old, opacity) {
            ...
            if (label && !isNaN(x)) {
                ...
                // apply step
                //JASPERSOFT #12
                index = axis.tickAmount && !horiz ? axis.tickAmount - index - 1 : index;
                //END JASPERSOFT #12
                if (step && index % step) {
	 ...
	 */
        ...
        getOffset: function () {
            ...
            if (hasData || axis.isLinked) {
                ...
                if (
                        (side === 1  || side === 3 )
                        && axis.userOptions.labels && Math.abs(axis.userOptions.labels.rotation) >= 75
                        && ((axis.isXAxis && chart.inverted) || (!axis.isXAxis && !chart.inverted))
                        && tickPositions.length
                    ) {
                        labelOffset = ticks[tickPositions[0]].label.getBBox().width;
                } else {
                    each(tickPositions, function (pos) {
    ...
    extend(Chart.prototype, {
        ...
        showResetZoom: function () {
            ...
            this.resetZoomButton = chart.renderer.button(
                ...
                UNDEFINED,
                UNDEFINED,
                chart.options.chart.isHeatMapTimeSeriesChart // render HTML button
                //END JASPERSOFT #9
            ).attr({
        ...
        zoom: function (event) {
            ...
            if (!event || event.resetSelection) {
                ...
                each(event.xAxis.concat(event.yAxis), function (axisData) {
                    ...
                    //JASPERSOFT #11
                    if(axis.chart.options.chart.isHeatMapTimeSeriesChart) {
                        axisData.min = Math.round(axisData.min/axis.pointRange)*axis.pointRange;
                        axisData.max = Math.round(axisData.max/axis.pointRange)*axis.pointRange;
                    }
                    //END JASPERSOFT #11
