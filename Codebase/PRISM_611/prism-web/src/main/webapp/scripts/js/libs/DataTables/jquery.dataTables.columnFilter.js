...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" class="input ' + search_init + sCSSClass + '" value="' + inputvalue + '"/>');
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input type="text" class="input number_range_filter" id="' + sFromId + '" rel="' + i + '"/>');
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="input number_range_filter" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
