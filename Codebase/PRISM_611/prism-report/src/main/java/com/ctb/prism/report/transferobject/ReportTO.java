...
public class ReportTO extends BaseTO {
	...
	public void setOrgNodeLevelArr(String[] orgNodeLevelArr) {
		this.orgNodeLevelArr = orgNodeLevelArr;
	}
	...
	public List<com.ctb.prism.core.transferobject.ObjectValueTO> getCustomerProductList() {
		return customerProductList;
	}
	public void setCustomerProductList(List<com.ctb.prism.core.transferobject.ObjectValueTO> customerProductList) {
		this.customerProductList = customerProductList;
	}
	public List<com.ctb.prism.core.transferobject.ObjectValueTO> getOrgNodeLevelList() {
		return orgNodeLevelList;
	}
	public void setOrgNodeLevelList(List<com.ctb.prism.core.transferobject.ObjectValueTO> orgNodeLevelList) {
		this.orgNodeLevelList = orgNodeLevelList;
	}
	public List<com.ctb.prism.core.transferobject.ObjectValueTO> getAdminYear() {
		return adminYear;
	}
