	...
	<form:form method="POST" id="downloadStudentFile" modelAttribute="downloadStudentFile">
		...
		<div class="columns accordion with-padding" style="margin-bottom: 0">
			<a class="button" id="downloadStudentFileXML" style="cursor: pointer;">
				<span class="button-icon icon-download blue-gradient report-btn">XML</span> Generate Download File
			</a>
			<!--a class="button" id="downloadStudentFileCSV" style="cursor: pointer;">
				<span class="button-icon icon-download blue-gradient report-btn">CSV</span> Generate Download File
			</a-->
			<a class="button float-right" id="downloadStudentFileDAT" style="cursor: pointer;">
				<span class="button-icon icon-download blue-gradient report-btn">DAT</span> Generate Download File
			</a>
		</div>
	</form:form>
</div>