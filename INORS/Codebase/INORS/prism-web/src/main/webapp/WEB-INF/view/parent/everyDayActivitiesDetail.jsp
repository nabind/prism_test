...
<div id="" style="height: auto; width: auto">
	<h3>Everyday Activities: Grade 3</h3>
		...
		<ul class="big-menu blue-gradient collapsible" id="parentMenu">
			<li class="with-right-arrow" id="select-tooltip-1"><span>Explore
				...
				<ul class="white-gradient">
					...
					explore your child’s interests. Then help him take part in an
					...
					types of books get your child's attention? If your child doesn’t
			...
			<li class="with-right-arrow" id="select-tooltip-2"><span>Integrate
				...
				<ul class="white-gradient">
					<p>Children who have opportunities to learn at home do better
						...
						Research shows you can improve your child’s academic performance
						...
						For example, it’s important to drink eight 8-ounce glasses of
			...
			<li class="with-right-arrow" id="select-tooltip-3"><span>Read
				...
				<ul class="white-gradient">
					<p>Reading with your child for just twenty minutes a day can
						...
						amount of great children’s literature today. While you are
			...
			<li class="with-right-arrow" id="select-tooltip-4"><span>Help
				...
				<ul class="white-gradient">
					<p>Children do better in school when they know how to be
						...
						themselves as “good at math” or “bad at reading.” Explain to your
						...
						story in his own words. Ask your child’s teacher for ways to help.
						...
						your child’s teacher for ideas if necessary. For example, if your
