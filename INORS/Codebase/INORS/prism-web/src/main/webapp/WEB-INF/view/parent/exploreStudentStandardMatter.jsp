...
<hgroup id="main-title" class="thin">
	...
	<p class="big-message">
		...
		Standards, Testing, and NCLB
	</p>
	
	
	<p>

Parents and care takers, teachers, and schools all have a responsibility to help children acquire the skills and knowledge necessary to earn good jobs, 
make informed decisions, and become successful and contributing citizens. These skills and knowledge are described by your state's standards.

State testing is one important tool that is used to determine whether your child is achieving these important standards. 
In addition, state tests inform decisions regarding the effectiveness of schools' and districts' efforts to support your child. The federal legislation that sets the parameters for this decision-making process is known as the No Child Left Behind Act (or NCLB). NCLB is the 2002 reauthorization of the Elementary and Secondary Education Act.
...
<div class="" style="background-color: #FFF">
    ...
    is one way you can support your child’s education. By knowing what is expected, you can work with your child and his or her teacher(s) to reach these 
    important standards.
    ...
    test results will label him or her as a “good” or “bad” student. But tests help to identify your child's strengths and highlight skill areas that could 
    ...
    child's needs. As a parent, you may want to talk to your child's teacher(s) about how tests are being used to support instruction.
						...
						<li class="with-right-arrow" id="select-tooltip-1">
							<span>What Is No Child Left Behind (NCLB)?</span>
								<ul class="big-menu report-menu white-gradient">
									<p>
    On January 8, 2002, helping all children succeed in school became more than just a goal—it became law. NCLB is a law built upon the tenet that setting 
    ...
    As your child advances through school, you will probably ask the same question that many parents do: “How is my child doing?” Your child's teacher will 
    ...
    children reach the standards and which schools and districts need to make improvements. As part of NCLB, you will receive a “report card” for your 
