...
function getStudentReport(reportUrl, reportId, reportName, obj, tabCount) {
	...
	if(isrFileName == null || isrFileName == "null" || isrFileName == "" || isrFileName == " ") {
		linkContainer = linkContainer + '<a class="button compact icon-forbidden disabled with-tooltip" title="No Student Report Available" href="#"><span class="button-icon red-gradient"><span class="icon-download"></span></span>Student Report</a>';
	} else {
	...
	if(ipFileName == null || ipFileName == "null" || ipFileName == "" || ipFileName == " ") {
		linkContainer = linkContainer + '<a class="button compact icon-forbidden red disabled with-tooltip margin-left" title="No Image Print Available" href="#"><span class="button-icon red-gradient"><span class="icon-download"></span></span>Image PDF</a>';
	} else {
