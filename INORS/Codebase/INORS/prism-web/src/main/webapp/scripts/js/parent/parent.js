...
$(document).ready(function() {
	...
	function getStudentPage(urlParam, obj) {
		blockUI();
		var dataUrl = 'subtestId='+$(obj).attr('subtestId')+'&studentBioId='+$(obj).attr('studentBioId')+'&studentName='+$(obj).attr('studentName')+'&studentGradeName='+$(obj).attr('studentGradeName')+'&studentGradeId='+$(obj).attr('studentGradeId')+'&articleId='+$(obj).attr('articleId')+'&contentType='+$(obj).attr('contentType');
		 $.ajax({
			type : "GET",
			url : urlParam,
			data : dataUrl,
