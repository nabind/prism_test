 ...
 (function($) {
	 ...
	 var methods = {
			...
			for (var i = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "creditCard":
						...
						break;
					//------------Added For Parent Network Starts
					case "equalsPassword": 
						errorMsg = methods._equalsPassword(field, rules, i, options);
						break;
					case "equalsEmail": 
						errorMsg = methods._equalsEmail(field, rules, i, options);
						break;	
					//------------Added For Parent Network Ends
		...
		*/
		...
		//-------------------------------Added For Parent Network Starts-------------------------------
		_equalsPassword: function(field, rules, i, options) {
			var equalsField = rules[i + 1];

			if (field.val() != $("#" + equalsField).val())
				return options.allrules.equalsPassword.alertText;
		},
		
		_equalsEmail: function(field, rules, i, options) {
			var equalsField = rules[i + 1];

			if (field.val() != $("#" + equalsField).val())
				return options.allrules.equalsEmail.alertText;
		},
		//-------------------------------Added For Parent Network Ends-------------------------------		
		/**
