...
(function(global) {
	...
	var jr = {
				global: {
					...
					JQUERY: {
						CORE: '/scripts/js/libs/jquery-1.7.2.min.js',
						UI: '/scripts/js/libs/jquery-ui.min.js'
					},
		...
		jQuery.fn.loadmask = function(options) {
			return this.each(function(){
				...
				if('string' == typeof options) {
					...
					settings = {
							bgimage : gm.APPLICATION_CONTEXT_PATH + '/themes/acsi/img/jasper/loadmask.png',
							loadinggif: gm.APPLICATION_CONTEXT_PATH + '/themes/acsi/img/standard/loaders/loading32.gif',
							opacity: 0.3
					};
