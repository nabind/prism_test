...
public interface IApplicationConstants {
	...
	public static enum ROLE_TYPE {
		ROLE_ACSI, ROLE_SCHOOL, ROLE_CLASS, ROLE_PARENT, ROLE_CTB, ROLE_USER, ROLE_ADMIN, ROLE_OAS, ROLE_SUPER
	};
	...
	// public static final String CURR_ADMIN_YEAR = "2013";
	// public static final String LAST_ADMIN_YEAR = "2012";
