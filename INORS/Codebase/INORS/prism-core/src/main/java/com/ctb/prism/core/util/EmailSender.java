...
public class EmailSender {
	...
	/*
	 * public static void main(String[] args) { ArrayList attachment = new
	 * ArrayList(); try { sendMail("prism_dev_informatica", "25",
	 * "acsi@ctb.com", "amit_dhara@ctb.com", "", "", "Subj test", "body test",
	 * attachment); } catch (Exception e) { e.printStackTrace(); } }
	 */

	public static void sendMail(final Properties prop, String recipientEmail,
			String attachment, String attachmentTwo, String subject,
		...
		if (host == null || port == null) {
			throw new Exception(
					"Make sure smtp parametres are correctly defined");
		}

		// sendMail(host, port, sender, recipientEmail, "", supportEmail,
		// subject, mailBody, attach);
		sendHTMLMail(host, port, sender, recipientEmail, "", supportEmail,
				subject, mailBody, attach);
	}
	 ...
	 *         message
	 */
	public static String sendMail(String asSmtpServer, String port,
			String asSender, String asRecipient, String asCcRecipient,
			String asBccRecipient, String asSubject, String asBody,
		...
		try {
			...
			/**
			 * Extracts the senders and adds them to the message. Sender is a
			...
			/**
			 * Extract the recipients and assign them to the message. Recipient
			 * is a comma-separated list of e-mail addresses as per RFC822.
			 */
	...
	public static String sendHTMLMail(String asSmtpServer, String port,
			String asSender, String asRecipient, String asCcRecipient,
			String asBccRecipient, String asSubject, String asBody,
			ArrayList arAttachments) throws Exception {
