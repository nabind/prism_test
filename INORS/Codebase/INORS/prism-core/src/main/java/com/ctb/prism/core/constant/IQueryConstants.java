...
public interface IQueryConstants extends IUserQuery, IOrgQuery, IParentQuery, IReportQuery, IInorsQuery, IEducationQuery, IWSQuery {
 ...
 // query to insert report role relation in report_role table
	...
	// TODO : GET_ALL_STUDENT_TABLE_GD > REWRITE WHERE CLAUSE
	public static final String GET_ALL_STUDENT_TABLE_GD = "SELECT STUDENT_BIO_ID VALUE, REPLACE(FIRST_NAME || ' ' || MIDDLE_NAME || ' ' || LAST_NAME, '  ', ' ') AS NAME, ORG_NODEID OTHER FROM STUDENT_BIO_DIM WHERE ORG_NODEID = ?";
