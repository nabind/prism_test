...
public interface IUserQuery {
	...
	public static final String GET_USER_DATA = CustomStringUtil.appendString(
			...
			" ABC.FULLNAME, DECODE(ABC.STATUS, 'AC', 'ENABLED', 'DISABLED') AS STATUS, ABC.ORG_NODE_NAME, ABC.ORG_LABEL, R.DESCRIPTION",
			...
			" FROM USERS USR, ORG_USERS ORGUSER, (SELECT *  FROM ORG_NODE_DIM",
			" START WITH ORG_NODEID = ?",
			" CONNECT BY PRIOR ORG_NODEID = PARENT_ORG_NODEID) HIER, ORG_TP_STRUCTURE OTS",
