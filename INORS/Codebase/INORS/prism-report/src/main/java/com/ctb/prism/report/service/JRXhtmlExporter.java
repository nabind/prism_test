...
/**
 * IMPORTANT :: Tthis class is fetched from jasper server jar file and needs to remove once the issue is resolved by jasper * fix IE 9 and 10 issue for text rotation
 * @author Amit Dhara
 *
 */
...
//			appendSizeStyle(rotatedText, rotatedText, styleBuffer);
			...
			styleBuffer.append("rotate(" + rotationAngle + "deg); ");
			// Added by TCS to fix IE 9 and 10 issue for text rotation
			styleBuffer.append("-ms-transform: translate(" + translateX + "px," + translateY + "px) ");
			styleBuffer.append("rotate(" + rotationAngle + "deg); ");
			// END : Added by TCS to fix IE 9 and 10 issue for text rotation
