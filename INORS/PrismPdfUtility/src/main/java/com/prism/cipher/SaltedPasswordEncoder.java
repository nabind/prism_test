...
/**
 * This wrapper class used to return encrypted password using SHA A salt is used
 * to encrypt the password hash Same encryption algorithm should be used in
 * spring authentication and java utility that generates user password
 * 
 * @author Amit Dhara
 *
 */
