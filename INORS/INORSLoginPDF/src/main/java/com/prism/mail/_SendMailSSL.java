...
public class _SendMailSSL {
	...
	public static void main(String[] args) {
		...
		/*if(args == null  || args.length < 3) {
			...
			System.out.println("Usage -> mailTo yourGmailId yourGmailPassword message ");
		} else {
			//sendmail(args[0], args[1], args[2], args[3]);
		}*/
	}
	
	public static String sendHTMLMail(String asRecipient, String asSubject, String asBody)
			throws Exception {
