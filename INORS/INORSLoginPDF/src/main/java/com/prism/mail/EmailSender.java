...
public class EmailSender {
	...
	public static void sendMail(final Properties prop, String recipientEmail, String attachment, String attachmentTwo,
			String subject, String mailBody, String supportEmail) throws Exception {
	...
	// For sending the mail to the tagged mail id of the respective org and edu center for log in info pdf opening
	
	public static void sendMail(final Properties prop, String recipientEmail,String subject, String mailBody,String supportEmail) throws Exception {
		String host = prop.getProperty("mail.smtp.host");
		String port = prop.getProperty("mail.smtp.port");
		String sender = prop.getProperty("senderMail");
		//String supportEmail = prop.getProperty("supportEmail");
		...
		sendHTMLMail(host, port, sender, recipientEmail, "", supportEmail, subject, mailBody,null);
	}
