...
public interface Constants {
	...
	public static final String GET_STUDENT_ID_LIST = CustomStringUtil.appendString(
			...
			" ORDER BY 1 DESC"*/
			"SELECT DISTINCT TEST_ELEMENT_ID FROM INVITATION_CODE WHERE ORG_NODEID = ? AND IS_NEW_IC = 'Y' ORDER BY 1 DESC"
			);
	public static final String GET_NEW_STUDENTS = CustomStringUtil.appendString(
			"SELECT TEST_ELEMENT_ID FROM INVITATION_CODE WHERE ORG_NODEID = ? AND IS_NEW_IC = 'Y' "
			);
