...
values(DB_REPORT_ID_SEQ.Nextval,'Manage Users','Manage Users','API_LINK','userModule.do','AC',sysdate,1);

insert into dash_reports(db_reportid,report_name,report_desc,report_type,report_folder_uri,activation_status,created_date_time,projectid)
values(DB_REPORT_ID_SEQ.Nextval,'Manage Organizations','Manage Organizations','API_LINK','manageOrganizations.do','AC',sysdate,1);

insert into dash_reports(db_reportid,report_name,report_desc,report_type,report_folder_uri,activation_status,created_date_time,projectid)
values(DB_REPORT_ID_SEQ.Nextval,'Manage Parents','Manage Parents','API_LINK','manageParent.do','IN',sysdate,1);
...
insert into dash_reports(db_reportid,report_name,report_desc,report_type,report_folder_uri,activation_status,created_date_time,projectid)
values(DB_REPORT_ID_SEQ.Nextval,'Manage Content','Manage Content','API_LINK','manageContent.do','IN',sysdate,1);
...
--For INORS
insert into dash_reports(db_reportid,report_name,report_desc,report_type,report_folder_uri,activation_status,created_date_time,projectid)
values(DB_REPORT_ID_SEQ.Nextval,'Manage Users','Manage Users','API_LINK','userModule.do','AC',sysdate,2);

insert into dash_reports(db_reportid,report_name,report_desc,report_type,report_folder_uri,activation_status,created_date_time,projectid)
values(DB_REPORT_ID_SEQ.Nextval,'Manage Organizations','Manage Organizations','API_LINK','manageOrganizations.do','AC',sysdate,2);

insert into dash_reports(db_reportid,report_name,report_desc,report_type,report_folder_uri,activation_status,created_date_time,projectid)
values(DB_REPORT_ID_SEQ.Nextval,'Manage Parents','Manage Parents','API_LINK','manageParent.do','AC',sysdate,2);
...
insert into dash_reports(db_reportid,report_name,report_desc,report_type,report_folder_uri,activation_status,created_date_time,projectid)
values(DB_REPORT_ID_SEQ.Nextval,'Manage Content','Manage Content','API_LINK','manageContent.do','AC',sysdate,2);
