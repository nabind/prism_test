...
---TASC MISING INDEXES FROM PERF
CREATE INDEX MV_STUDENT_DETAILS_INDX ON MV_STUDENT_DETAILS
(GRADEID, ETHINICITY, LANGUAGE, ORG_NODEID, STUDENT_BIO_ID, 
SUBTESTID, DATE_TEST_TAKEN, STATE_QUESTION_1, STATE_QUESTION_2, STATE_QUESTION_3, 
STATE_QUESTION_4, STATE_QUESTION_5, EDU_CENTERID);
 
CREATE INDEX MV_STUDENT_DETAILS_INDX2 ON MV_STUDENT_DETAILS
(ORG_NODEID, UPPER("FIRST_NAME"), UPPER("LAST_NAME"), UPPER("MIDDLE_NAME"), BIRTHDATE, 
GENDERID, EXT_STUDENT_ID, TEST_FORMAT, LANGUAGE, STUDENT_BIO_ID, 
SUBTESTID);  
 
CREATE INDEX IDX_SUBTEST_DIM ON SUBTEST_DIM
(SUBTESTID, SUBTEST_CODE);  
 
CREATE INDEX MV_TEST_PROGRAM_INDX ON MV_TEST_PROGRAM
(CUSTOMERID); 
