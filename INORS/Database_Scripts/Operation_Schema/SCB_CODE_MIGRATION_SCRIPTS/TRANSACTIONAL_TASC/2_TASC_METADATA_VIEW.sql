...
SELECT DB_ACT_ACCESSID,
 ...
 WHERE CUST_PROD_ID IN
       (SELECT CUST_PROD_ID
         ...
         WHERE PRODUCTID IN
               (SELECT PRODUCTID FROM prism_global.PRODUCT WHERE PROJECTID = 1));
...
SELECT TP_ID,
 ...
 WHERE CUSTOMERID IN
       (SELECT CUSTOMERID FROM prism_global.CUSTOMER_INFO WHERE PROJECTID = 1)
   AND ADMINID IN
       (SELECT ADMINID FROM prism_global.ADMIN_DIM WHERE PROJECTID = 1);
