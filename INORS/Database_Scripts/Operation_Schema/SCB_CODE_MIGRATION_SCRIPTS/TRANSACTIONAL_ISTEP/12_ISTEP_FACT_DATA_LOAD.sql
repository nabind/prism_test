...
INSERT /*+APPEND*/ INTO ORG_NODE_DIM
  ...
  SELECT ORG_NODEID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.ORG_NODE_DIM;
...
INTO ORG_PRODUCT_LINK
  ...
  SELECT ORG_PROD_ID, ORG_NODEID, CUST_PROD_ID, DATETIMESTAMP
    FROM istepprodcopy.ORG_PRODUCT_LINK;
...
INTO ORG_TEST_PROGRAM_LINK
  ...
  SELECT ORG_NODEID, TP_ID, DATETIMESTAMP
    FROM istepprodcopy.ORG_TEST_PROGRAM_LINK;
...
INTO STUDENT_BIO_DIM
  ...
  SELECT STUDENT_BIO_ID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.STUDENT_BIO_DIM;
...
INTO SUBTEST_SCORE_FACT
  ...
  SELECT SUBTEST_FACTID,
         ...
         TEST_DATE,
         DATETIMESTAMP
    FROM istepprodcopy.SUBTEST_SCORE_FACT;
...
BEGIN
  ...
  FOR REC IN (SELECT DISTINCT CUST_PROD_ID FROM istepprodcopy.OBJECTIVE_SCORE_FACT) LOOP
    ...
    INTO OBJECTIVE_SCORE_FACT
      ...
      SELECT OBJECTIVE_FACTID,
             ...
             TEST_DATE,
             DATETIMESTAMP
        FROM istepprodcopy.OBJECTIVE_SCORE_FACT O
...
INTO OBJECTIVE_SCORE_FACT
  ...
  SELECT OBJECTIVE_FACTID,
         ...
         TEST_DATE,
         DATETIMESTAMP
    FROM istepprodcopy.OBJECTIVE_SCORE_FACT;
...
INTO GRADE_SELECTION_LOOKUP
  ...
  SELECT ORG_NODEID,
         ...
         FORMID,
         DATETIMESTAMP
    FROM istepprodcopy.GRADE_SELECTION_LOOKUP;
...
INTO DEMOGRAPHIC
  ...
  SELECT DEMOID,
         ...
         IS_DEMO_VALUE_AVL,
         DATETIMESTAMP
    FROM istepprodcopy.DEMOGRAPHIC;
...
INTO DEMOGRAPHIC_VALUES
  ...
  SELECT DEMO_VALID,
         ...
         IS_DEFAULT,
         DATETIMESTAMP
    FROM istepprodcopy.DEMOGRAPHIC_VALUES;
...
INTO STUDENT_DEMO_VALUES
  ...
  SELECT STU_DEMO_VALID,
         ...
         DEMO_VALUE,
         DATETIMESTAMP
    FROM istepprodcopy.STUDENT_DEMO_VALUES;
...
INTO INVITATION_CODE
  ...
  SELECT ICID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.INVITATION_CODE;
...
INTO INVITATION_CODE_CLAIM
  ...
  SELECT ICID,
         ...
         UPDATED_DATE_TIME,
         INVITATION_CODE_CLAIM_ID
    FROM istepprodcopy.INVITATION_CODE_CLAIM;
...
INTO INVITATION_CODE_LOOKUP
  ...
  SELECT COLUMN_NAME, COLUMN_VALUE
    FROM istepprodcopy.INVITATION_CODE_LOOKUP;
...
INTO USER_SELECTION_LOOKUP
  ...
  SELECT USERID, CUST_PROD_ID, GRADEID, SUBTESTID, DATETIMESTAMP
    FROM istepprodcopy.USER_SELECTION_LOOKUP;
...
INTO PWD_HINT_ANSWERS
  ...
  SELECT PH_ANSWERID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.PWD_HINT_ANSWERS;
...
INTO ARTICLE_CONTENT
  ...
  SELECT ARTICLE_CONTENT_ID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.ARTICLE_CONTENT;
...
INTO ARTICLE_METADATA
  ...
  SELECT ARTICLEID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.ARTICLE_METADATA;
...
INTO USER_ACTIVITY_HISTORY
  ...
  SELECT ACTIVITYID,
         ...
         IP_ADDRESS,
         DATETIMESTAMP
    FROM istepprodcopy.USER_ACTIVITY_HISTORY;
...
INTO JOB_TRACKING
  ...
  SELECT JOB_ID,
         ...
         OTHER_REQUEST_PARAMS,
         FILE_SIZE
    FROM istepprodcopy.JOB_TRACKING;
...
INTO BIO_STUDENT_EXTRACT
  ...
  SELECT BIO_EXTRACTID,
         ...
         GRADE,
         CREATED_DATE_TIME
    FROM istepprodcopy.BIO_STUDENT_EXTRACT;
...
INTO PERF_MATRIX_FACT
  ...
  SELECT PERF_MATRIX_ID,
         ...
         PERF_LEVEL,
         DATETIMESTAMP
    FROM istepprodcopy.PERF_MATRIX_FACT;
...
INTO CUTSCOREIPI
  ...
  SELECT CUTSCOREIPIID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.CUTSCOREIPI;
...
INTO CUTSCORESCALESCORE
  ...
  SELECT CUTSCORESCALESCOREID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.CUTSCORESCALESCORE;
...
INTO STATE_MEAN_IPI_SCORE
  ...
  SELECT STATE_MEAN_IPI_SCOREID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.STATE_MEAN_IPI_SCORE;
...
INTO DISAGGREGATION_CATEGORY
  ...
  SELECT DISAGGREGATIONCATEGORYID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.DISAGGREGATION_CATEGORY;
...
INTO DISAGGREGATION_CATEGORY_TYPE
  ...
  SELECT DISAGGREGATIONCATEGORYTYPEID,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.DISAGGREGATION_CATEGORY_TYPE;
...
INTO ASFD_ORDERBY
  ...
  SELECT ASFD_ORDERBYID,
         ...
         ORDERBY,
         CUST_PROD_ID
    FROM istepprodcopy.ASFD_ORDERBY;
...
INTO ACAD_STD_SUMM_FACT
  ...
  SELECT AS_SUMM_ID,
         ...
         ISPUBLIC,
         DATETIMESTAMP
    FROM istepprodcopy.ACAD_STD_SUMM_FACT;
...
INTO UDTR_ROSTER_FACT
  ...
  SELECT UDTR_ROSTER_ID,
         ...
         ISPUBLIC,
         DATETIMESTAMP
    FROM istepprodcopy.UDTR_ROSTER_FACT;
...
INTO UDTR_SUMM_FACT
  ...
  SELECT UDTR_SUMM_ID,
         ...
         ISPUBLIC,
         DATETIMESTAMP
    FROM istepprodcopy.UDTR_SUMM_FACT;
...
INTO CLASS_SUMM_FACT
  ...
  SELECT CLASS_SUMM_ID,
         ...
         ISPUBLIC,
         DATETIMESTAMP
    FROM istepprodcopy.CLASS_SUMM_FACT;
...
INTO RESULTS_GRT_FACT
  ...
  SELECT RESULTS_GRTID,
         ...
         CREATED_DATETIME,
         UPDATED_DATETIME
    FROM istepprodcopy.RESULTS_GRT_FACT;
...
INTO USABILITY_LOG
  ...
  SELECT REPORT_URL,
         ...
         CURRENTORG,
         LOGGED_ON
    FROM istepprodcopy.USABILITY_LOG;
...
INTO ORG_LSTNODE_LINK
  ...
  SELECT ORG_LSTNODEID, ORG_NODEID, ADMINID, DATETIMESTAMP
    FROM istepprodcopy.ORG_LSTNODE_LINK;
...
INTO STUDENT_PDF_FILES
  ...
  SELECT STU_PDF_FILEID,
         ...
         IS_FILE_EXISTS,
         DATETIMESTAMP
    FROM istepprodcopy.STUDENT_PDF_FILES;
...
INTO USERS_MAP
  ...
  SELECT USERID, DATETIMESTAMP FROM istepprodcopy.USERS_MAP;
...
INTO STG_DATA_LAYOUT_CONFIG
  ...
  SELECT SEQ_NO,
         ...
         DATETIMESTAMP,
         PRODUCT_CODE
    FROM istepprodcopy.STG_DATA_LAYOUT_CONFIG;
...
INTO STG_ETL_JOBMASTER
  ...
  SELECT MAPPING_NAME,
         ...
         CREATED_DATE_TIME,
         UPDATED_DATE_TIME
    FROM istepprodcopy.STG_ETL_JOBMASTER;
...
INTO STG_PROCESS_STATUS
  ...
  SELECT PROCESS_ID,
         ...
         PROCESS_LOG,
         DATETIMESTAMP
    FROM istepprodcopy.STG_PROCESS_STATUS;
