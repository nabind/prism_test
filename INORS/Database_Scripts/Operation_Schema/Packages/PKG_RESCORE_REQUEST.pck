    ...
    OPEN P_OUT_CUR_DNP FOR
      SELECT RRF.STUDENT_BIO_ID STUDENT_BIO_ID,
        ...
        FROM RESCORE_REQUEST_FORM RRF,
             ITEMSET_DIM          ISD /*, SUBTEST_DIM SD*/,
             CUST_PRODUCT_LINK    CPL
       WHERE RRF.ITEMSETID = ISD.ITEMSETID
            /*AND RRF.SUBTESTID = SD.SUBTESTID*/
         AND RRF.ELIGIBLE_FOR_RESCORE = 'Y'
      ...
      /*AND SD.SUBTEST_CODE = 'ELA'*/
       ORDER BY ISD.SESSION_ID, RRF.ITEMSETID, STUDENT_FULL_NAME;
