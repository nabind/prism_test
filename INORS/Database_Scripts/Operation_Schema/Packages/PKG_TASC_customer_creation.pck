create or replace package PKG_TASC_customer_creation is
...
/
create or replace package body PKG_TASC_customer_creation is
  ...
  procedure SP_TASC_CREATE_CUSTOMER_GRANT is
  begin
    null;
  end;
