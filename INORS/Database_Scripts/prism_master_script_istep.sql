...
-- Run PRC_REPORT_CONFIGURATION(1) manually
-- Run PRC_CONFIGURATION(2) manually
--@\Operation_Schema\InsertScript\master_insert_istep.sql; --Need to run one time. Un-comment the line before running. Please run it manually
