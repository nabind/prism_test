  ...
  <script type="text/javascript" src="jquery.min.js"></script>
    ...
    <script>
		...
		function update_rows() {
			...
			$(".table tr:odd").css("background-color", "#fffccc");
...
<body>
	<%
 	...
 	if(allStudents == null) System.out.println("nulllllllllllllllllllllll");
 		long pageNumber = 0;
	...
	<div class="example-nav">
		...
		<div class="studentHeader">
			<div class="headerText">
				...
				<div>
					<span class="headerText4">Content:</span> <span class="headerText3"><%=contentTO.getContentName() %></span>&nbsp;&nbsp;
					<span class="headerText4">Grade: </span> <span class="headerText3"><%=studentTO.getGrade() %></span>
				</div>
			</div>
		</div>
...
<%
		...
		if(scoreTO.getContent().size()%2 != 0) {
			// odd number of content present; we need to keep one page blank
			%>
			<div class="example-content" style="border:0px solid red; width:760px; height:1045px;"></div>
			<div class="footer example-content">
				<div style="float:right">
					<span class="footerPageNumber">Page <%=++pageNumber %> of <%=totalPages %></span>
				</div>
