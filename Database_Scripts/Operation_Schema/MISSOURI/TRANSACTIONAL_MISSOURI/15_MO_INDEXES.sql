...
CREATE BITMAP INDEX BIDX_MV_RPRT_STUD_DETAILS ON MV_RPRT_STUD_DETAILS (STUDENT_BIO_ID,CUST_PROD_ID,SUBTESTID,GRADEID);
CREATE BITMAP INDEX BIDX_ARTICLE_METADATA_1 ON ARTICLE_METADATA (CUST_PROD_ID,SUBTESTID,CATEGORY_TYPE,GRADEID,PROFICIENCY_LEVEL);
CREATE INDEX IDX_ARTICLE_METADATA_1 ON ARTICLE_METADATA(ARTICLE_CONTENT_ID);
