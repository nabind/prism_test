...
SELECT DB_ACT_ACCESSID,
 ...
 WHERE CUST_PROD_ID IN
       (SELECT CUST_PROD_ID
         ...
         WHERE PRODUCTID IN
               (SELECT PRODUCTID FROM prismglobal.PRODUCT WHERE PROJECTID = 3));
...
SELECT TP_ID,
 ...
 WHERE CUSTOMERID IN
       (SELECT CUSTOMERID FROM prismglobal.CUSTOMER_INFO WHERE PROJECTID = 3)
   AND ADMINID IN
       (SELECT ADMINID FROM prismglobal.ADMIN_DIM WHERE PROJECTID = 3);
