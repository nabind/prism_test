CREATE OR REPLACE FUNCTION SF_GET_STUDENT(LoggedInUserJasperOrgId IN ORG_NODE_DIM.ORG_NODEID%TYPE,
  ...
  ************************************************************************************/
  ...
  CURSOR c_Get_Student(Product_Id PRODUCT.PRODUCTID%TYPE,
                       School_Id  ORG_NODE_DIM.ORG_NODEID%TYPE,
                       Grade_Id   GRADE_DIM.GRADEID%TYPE) IS
    SELECT DISTINCT FINL.STUDENT_BIO_ID, FINL.STUDENT_FULL_NAME
      FROM (SELECT RRF.STUDENT_BIO_ID STUDENT_BIO_ID,
             ...
             WHERE RRF.ORG_NODEID = OND.ORG_NODEID
               ...
               AND RRF.SUBTESTID = SD.SUBTESTID) FINL
  ...
  CURSOR c_Get_Grade_Default(Product_Id PRODUCT.PRODUCTID%TYPE,
                             org_id     ORG_NODE_DIM.ORG_NODEID%TYPE) IS
  ...
  CURSOR c_Get_Grade_SchoolOth(Product_Id    PRODUCT.PRODUCTID%TYPE,
                               test_program1 NUMBER) IS
...
BEGIN
  ...
  IF p_type = v_ALL_SCHOOL_OTH THEN
    ...
    IF (p_corpdiocese = -99 OR p_corpdiocese IS NULL) AND
      ...
      END IF;
      ---get default grade
      FOR r_Get_Grade_SchoolOth IN c_Get_Grade_SchoolOth(v_ProductId,
                                                         v_test_program) LOOP
        t_PRS_PGT_GLOBAL_TEMP_OBJ := PRS_PGT_GLOBAL_TEMP_OBJ();
    ...
    ELSIF p_school = -99 AND p_corpdiocese = -1 THEN
      ...
      ---get default grade
      FOR r_Get_Grade_SchoolOth IN c_Get_Grade_SchoolOth(p_test_administration,
                                                         v_test_program) LOOP
        t_PRS_PGT_GLOBAL_TEMP_OBJ := PRS_PGT_GLOBAL_TEMP_OBJ();
  ...
  ELSIF p_type = v_SCHOOL_OTH AND v_OrgNodeLevel < 4 THEN
    ...
    IF (p_corpdiocese = -99 OR p_corpdiocese IS NULL) AND
      ...
      ---get default grade
      FOR r_Get_Grade IN c_Get_Grade_Default(v_ProductId, v_SchoolId) LOOP
        v_GradeId := r_Get_Grade.GRADEID;
      END LOOP;
    
      ---get default students
      FOR r_Get_Student IN c_Get_Student(v_ProductId, v_SchoolId, v_GradeId) LOOP
        t_PRS_PGT_GLOBAL_TEMP_OBJ := PRS_PGT_GLOBAL_TEMP_OBJ();
    ...
    ELSIF p_school = -99 AND p_corpdiocese <> -1 THEN
      ...
      ---get default grade
      FOR r_Get_Grade IN c_Get_Grade_Default(p_test_administration,
                                             v_SchoolId) LOOP
        v_GradeId := r_Get_Grade.GRADEID;
      END LOOP;
    
      ---get default student
      FOR r_Get_Student IN c_Get_Student(p_test_administration,
                                         v_SchoolId,
                                         v_GradeId) LOOP
        t_PRS_PGT_GLOBAL_TEMP_OBJ := PRS_PGT_GLOBAL_TEMP_OBJ();
    ...
    ELSIF p_school = -99 AND p_corpdiocese = -1 THEN
      ...
      ---get default grade
      FOR r_Get_Grade IN c_Get_Grade(p_test_administration, v_SchoolId) LOOP
        t_PRS_PGT_GLOBAL_TEMP_OBJ := PRS_PGT_GLOBAL_TEMP_OBJ();
  ...
  ELSIF p_type = v_ALL_OPTION_TOGGLE_WITH_LEVEL THEN
    ...
    IF (p_corpdiocese = -99 OR p_corpdiocese IS NULL) AND
      ...
      ELSE
        ...
        END LOOP;*/
        ---get default grade
        FOR r_Get_Grade IN c_Get_Grade(v_ProductId, v_CorpId) LOOP
          t_PRS_PGT_GLOBAL_TEMP_OBJ := PRS_PGT_GLOBAL_TEMP_OBJ();
  ...
  ELSIF p_type = 'DISTRICT_ONLY' THEN
    IF p_corpdiocese = -99 OR p_corpdiocese IS NULL THEN
      ...
      END IF;
      ----get default grade
      FOR r_Get_Grade_DistrictOnly IN c_Get_Grade_SchoolOth(v_ProductId,
                                                            v_test_program) LOOP
        t_PRS_PGT_GLOBAL_TEMP_OBJ := PRS_PGT_GLOBAL_TEMP_OBJ();
