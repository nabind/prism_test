SELECT * FROM CUSTOMER_INFO WHERE CUSTOMER_NAME ='Wisconsin State DPI';--1106
SELECT * FROM CUST_PRODUCT_LINK WHERE CUSTOMERID = 1106; --5141
...
BEGIN
	...
	INSERT INTO ORG_NODE_DIM VALUES (0,'ROOT','ROOT',0,'NA','NA','PUBLIC',0,NULL,NULL,V_CUSTOMERID,SYSDATE,SYSDATE);
	INSERT INTO ORG_NODE_DIM VALUES (SEQ_ORG_NODE_DIM.NEXTVAL,'Wisconsin State DPI','WI',1,'WI','WI','PUBLIC',0,'0~WI',NULL,V_CUSTOMERID,SYSDATE,SYSDATE);
	COMMIT;
END;
...
BEGIN
  SELECT CUSTOMERID INTO V_CUSTOMERID FROM CUSTOMER_INFO WHERE CUSTOMER_NAME ='Wisconsin State DPI';	
  SELECT CUST_PROD_ID INTO V_CUST_PROD_ID FROM CUST_PRODUCT_LINK WHERE CUSTOMERID =V_CUSTOMERID;

  FOR I IN (SELECT ORG_NODEID FROM ORG_NODE_DIM WHERE CUSTOMERID =V_CUSTOMERID) LOOP
