  ...
  BEGIN
    ...
    OPEN P_OUT_CUR_MIG_DETAILS FOR
      SELECT DISTINCT FACT.TAPE_MODE,
                      ...
                      '' FILLER_1, -- TODO -- NF
                      '' FILLER,
                      FACT.NRT_FORM FORM_FOR_SCORING,
                      ...
                      FACT.IMAGEID_ELA,
                      FACT.TEXT_READER_INDICATOR_PART_1,
                      FACT.TEXT_READER_INDICATOR_PART_2,
                      FACT.ELA_CR_SESSION_3,
                      FACT.ELA_CR_SESSION_4B_ITEM_RESP,
                      FACT.ELA_CR_SESSION_5_ITEM_RESP,
                      FACT.ELA_CR_SESSION_6B_ITEM_RESP,
                      FACT.MATH_CR_SESSION_2_ITEM_RESP,
                      FACT.SCI_CR_SESSION_7_ITEM_RESP,
