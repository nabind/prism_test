...
-------------------------------------------------------------
---needed for production migration to production 
CREATE TABLE GRW_USER_SELECTION_LOOKUP_2013 AS SELECT * FROM 
ISTEP_DEV_ETL.GRW_USER_SELECTION_LOOKUP_2013@PROD_TO_ISTEPMASTER;
---SELECT COUNT(1) FROM GRW_USER_SELECTION_LOOKUP_2013;--23919
--SELECT * FROM GRW_USER_SELECTION_LOOKUP_2013;
-------------------------------------------------------------
...
SELECT (SELECT MP.GENARATED_ORG_USER_ID 
 ...
 ------------------------------------------------------------- 
 ---needed for production migration to production 
 CREATE TABLE GRW_USC_LINK_2013 AS SELECT * FROM
 ISTEP_DEV_ETL.GRW_USC_LINK_2013@PROD_TO_ISTEPMASTER;
...
------------------------------------------------------------- 
 ---needed for production migration to production 
 CREATE TABLE GRW_PERF_MATRIX_FACT_2013 AS SELECT * FROM
 ISTEP_DEV_ETL.GRW_PERF_MATRIX_FACT_2013@PROD_TO_ISTEPMASTER;
