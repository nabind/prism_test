...
---------Below query shows tha mismatches in 2013 users ------
SELECT MAX (u.userid)
FROM users u, org_users o 
WHERE u.userid = o.userid 
AND o.adminid IN (101)  
AND u.user_type IN ('GRW','GRW_P');


SELECT * FROM org_users WHERE userid IN (SELECT userid FROM users WHERE username IN ('100193913341',
'350017001',
'350025001',
'16001141001',
'16001197001',
