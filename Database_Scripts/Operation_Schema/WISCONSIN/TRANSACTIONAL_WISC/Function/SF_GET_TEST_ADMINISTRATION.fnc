...
BEGIN
        ...
        FOR r_Get_Product_Specific IN c_Get_Product_Specific
           LOOP
               ...
               t_PRS_PGT_GLOBAL_TEMP_OBJ.vc2 := r_Get_Product_Specific.ADMIN_NAME;
               t_PRS_PGT_GLOBAL_TEMP_OBJ.vc3 := r_Get_Product_Specific.ADMIN_SEQ;
