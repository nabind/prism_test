...
PKG_RPRT_STUD_DETAILS.SF_GET_STUDENT_DEMO_VALID( P_DEMOCODE=>'Braille',P_STUDENT_BIO_ID=>SCR.STUDENT_BIO_ID,P_CUSTOMER_CODE=>'MO') AS BRAILLE,
PKG_RPRT_STUD_DETAILS.SF_GET_STUDENT_DEMO_VALID( P_DEMOCODE=>'Large_Print',P_STUDENT_BIO_ID=>SCR.STUDENT_BIO_ID,P_CUSTOMER_CODE=>'MO') AS LARGE_PRINT,
PKG_RPRT_STUD_DETAILS.SF_GET_STUDENT_DEMO_VALID( P_DEMOCODE=>'Student_Groups',P_STUDENT_BIO_ID=>SCR.STUDENT_BIO_ID,P_CUSTOMER_CODE=>'MO') AS STUDENT_GROUPS,
