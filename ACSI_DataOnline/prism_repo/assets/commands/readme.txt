...
Variable 1
	...
	Variable Value: <<provide your prism source code path>> (e.q. C:\workspace\prism-repo)
...
#------------------- STEP 4 -------------------
Build code using the following command from PRISM_HOME
mvn install
...
#------------------- STEP 5 -------------------
Take the WAR file from PRISM_HOME\prism-web\target
