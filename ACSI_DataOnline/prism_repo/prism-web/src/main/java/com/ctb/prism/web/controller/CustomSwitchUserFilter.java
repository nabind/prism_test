...
public class CustomSwitchUserFilter extends GenericFilterBean implements
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		if (requiresSwitchUser(request)) {
			...
			try {
				...
				for(GrantedAuthority ga : targetUser.getAuthorities()) {
					if(ga instanceof SwitchUserGrantedAuthority) {
						LdapUserDetailsImpl userDetails = (LdapUserDetailsImpl) ((SwitchUserGrantedAuthority) ga).getSource().getPrincipal();
			...
			if(prevAdminUser != null) {
				LdapUserDetailsImpl userDetails = (LdapUserDetailsImpl) prevAdminUser.getPrincipal();
	...
	protected Authentication attemptSwitchUser(HttpServletRequest request)
		...
		UserDetails targetUser = userDetailsService
