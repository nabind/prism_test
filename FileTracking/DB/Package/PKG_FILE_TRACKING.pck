...
CREATE OR REPLACE PACKAGE BODY PKG_FILE_TRACKING AS
  ...
  BEGIN
    ...
    V_QUERY_ACTUAL := V_QUERY_ACTUAL || ' SELECT SCAN_BATCH,
                           ...
                           LARGE_PRINT,
                           DATE_TEST_TAKEN,
                           TO_CHAR(LOGINDATE, ''YYYY-MM-DD HH24:MI:SS'') LOGINDATE,
                           TO_CHAR(SCAN_DATE, ''YYYY-MM-DD HH24:MI:SS'') SCAN_DATE,
                           TO_CHAR(WINS_EXPORT_DATE, ''YYYY-MM-DD HH24:MI:SS'') WINS_EXPORT_DATE,
                           IMAGING_ID,
                           ORGTP_NAME,
                           LAST_NAME,
                           FIRST_NAME,
